...
public class dhry extends GlobalVariables {
	...
	System.out.println("Execution starts, " + Number_Of_Runs
	...
	System.out.println("Result: " + Number_Of_Runs * 1000 / total_time
			+ " dhrystone/sec.");
	...
	System.out.println("Dhrystone Benchmark, Version 2.1 (Language: Java)");
	System.out.println();
	System.out.println("Please give the number of runs through the benchmark: ");
	dhry dh = new dhry();
	try {
	    BufferedReader rdr
